window.MEDICAMENTOS_DATA = [
  ...
  },
  {
    ...
    "contraindicaciones_generales": [
      "No recomendado en personas con enfermedad cardiovascular grave.",
      "Precaución en personas con úlceras gástricas activas."
    ],
    "interacciones_generales": [
      "Puede interactuar con anticoagulantes.",
  ...
  },
  {
    ...
    "contraindicaciones_generales": [
      "Precaución en personas con insuficiencia renal.",
      "Consultar en caso de lactancia."
    ],
    "interacciones_generales": [
      "Puede potenciar el efecto sedante de otros medicamentos.",
