...
// Cálculo automático de costo y duración (regla del enunciado):
//   costo total = precio del servicio + suma de adicionales
//   duración total = SOLO la duración del servicio (los adicionales NO la
//   modifican) -> la hora fin se calcula sumando esa duración a la hora inicio.
