// Catálogos informativos: muestran datos del API sin permitir crear, editar o eliminar.
import { CatalogPage } from '../modules/catalog/CatalogPage'
type CatalogItem = { id: number; nombre: string; descripcion?: string; activo?: boolean }
// Columnas compartidas por roles, especialidades y estados de cita.
...
// Cada página solo configura el título y el endpoint que debe consultar.
...
// Pantallas de consulta para roles, especialidades y estados.
